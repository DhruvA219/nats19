...
if ($row['skewb']=='Y'){
 echo '<li class="nav-item"><input type="checkbox" disabled id="cb14" /> <label for="cb14"><img src="../img/eventscolor/skewb.png" /></label></li>';
      }
if ($row['sq1']=='Y'){
 echo '<li class="nav-item"><input type="checkbox" disabled id="cb15" /> <label for="cb15"><img src="../img/eventscolor/sq1.png" /></label></li>';
      }
if ($row['444bf']=='Y'){
 echo '<li class="nav-item"><input type="checkbox" disabled id="cb16" /> <label for="cb16"><img src="../img/eventscolor/4BLD.png" /></label></li>';
}
if ($row['555bf']=='Y'){
 echo '<li class="nav-item"><input type="checkbox" disabled id="cb17" /> <label for="cb17"><img src="../img/eventscolor/5BLD.png" /></label></li>';
      }
if ($row['333mbf']=='Y'){
 echo '<li class="nav-item"><input type="checkbox" disabled id="cb18" /> <label for="cb18"><img src="../img/eventscolor/MBLD.png" /></label></li>';
      }
